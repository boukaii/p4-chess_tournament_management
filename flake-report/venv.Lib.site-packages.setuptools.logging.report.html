      ...
      <div id="page">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.setuptools.logging.source.html#l28">
                  <tt><i>28</i>         <span class="c1"># For some reason `distutils.log` module is getting cached in `distutils.dist`</span></tt>
               </a>
            </li>
            </ul>
         </li>
