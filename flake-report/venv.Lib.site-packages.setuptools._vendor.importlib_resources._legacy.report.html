...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\setuptools\_vendor\importlib_resources\_legacy.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.setuptools._vendor.importlib_resources._legacy.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.setuptools._vendor.importlib_resources._legacy.source.html#l21">
